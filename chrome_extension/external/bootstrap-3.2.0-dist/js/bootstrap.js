...
+function ($) {
  ...
  Tooltip.prototype.applyPlacement = function (offset, placement) {
    ...
    var arrowPosition = delta.left
      ? 'left'
      : 'top'
    var arrowOffsetPosition = delta.left
      ? 'offsetWidth'
      : 'offsetHeight'
...
+function ($) {
  ...
  function ScrollSpy(element, options) {
    ...
    this.$body = $('body')
    this.$scrollElement = $(element).is('body')
      ? $(window)
      : $(element)
