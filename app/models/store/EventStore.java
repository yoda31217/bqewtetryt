...
public class EventStore {
  ...
  public static Event createOrGetEvent(EventType type, Date date, String firstSide, String secondSide, String code) {
    Event newEvent = new Event(type, date, firstSide, secondSide, code);
