...
public class LiveVolvoParser2
  ...
  public List<ParsedEvent> parse(byte[] input) {
    String sportDescr = webDriver.findElement(cssSelector(".ClassificationMenu .Classification.on span.title")).getText();
  ...
  public static String findElTextOrNull(WebElement rootEl, String selector, int index) {
    ...
    if (null == els || els.isEmpty() || els.size() <= index) return null;
