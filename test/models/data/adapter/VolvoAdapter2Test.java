...
public class VolvoAdapter2Test {
  ...
  @Test
  public void adapt_dateTextNotNull_returnAdaptedDate() throws Exception {
  ...
  @Test
  public void adapt_checkSport() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.sport).isEqualTo(TENNIS);
  }

  @Test
  public void adapt_checkSide1Name() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.side1).isEqualTo(SIDE_1);
  }

  @Test
  public void adapt_checkSide2Name() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.side2).isEqualTo(SIDE_2);
  }

  @Test
  public void adapt_checkLowKof() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.lowKof).isEqualTo(1.5);
  }

  @Test
  public void adapt_checkHighKof() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.highKof).isEqualTo(3.2);
  }

  @Test
  public void adapt_checkOrganisation() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.organisation).isEqualTo(VOLVO);
  }

  @Test
  public void adapt_checkCode() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, LOW_KOF_STR, HIGH_KOF_STR));
    assertThat(adaptedEvent.code).isEqualTo(SIDE_1_CODE + "_" + SIDE_2_CODE);
  }

  @Test
  public void adapt_checkSide1Name_flipped() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_2, SIDE_1, EVENT_DATE_TEXT, HIGH_KOF_STR, LOW_KOF_STR));
    assertThat(adaptedEvent.side1).isEqualTo(SIDE_1);
  }

  @Test
  public void adapt_checkSide2Name_flipped() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_2, SIDE_1, EVENT_DATE_TEXT, HIGH_KOF_STR, LOW_KOF_STR));
    assertThat(adaptedEvent.side2).isEqualTo(SIDE_2);
  }

  @Test
  public void adapt_checkLowKof_flipped() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_1, SIDE_2, EVENT_DATE_TEXT, HIGH_KOF_STR, LOW_KOF_STR));
    assertThat(adaptedEvent.lowKof).isEqualTo(1.5);
  }

  @Test
  public void adapt_checkHighKof_flipped() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_2, SIDE_1, EVENT_DATE_TEXT, HIGH_KOF_STR, LOW_KOF_STR));
    assertThat(adaptedEvent.highKof).isEqualTo(3.2);
  }

  @Test
  public void adapt_checkCode_flipped() throws Exception {
    AdaptedEvent adaptedEvent = adapter.adapt(new ParsedEvent("Tennis", SIDE_2, SIDE_1, EVENT_DATE_TEXT, HIGH_KOF_STR, LOW_KOF_STR));
    assertThat(adaptedEvent.code).isEqualTo(SIDE_1_CODE + "_" + SIDE_2_CODE);
  }
}