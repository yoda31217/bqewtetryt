...
public class EventFilterTest {
  ...
  public void apply_firstSport_returnTrue() {
    AdaptedEvent event = new AdaptedEvent(REGULAR, TABLE_TENNIS, null, null, 1.0, 1.0, null, null, null, null);
  ...
  public void apply_otherSport_returnFalse() {
    AdaptedEvent event = new AdaptedEvent(REGULAR, UNKNOWN, null, null, 1.0, 1.0, null, null, null, null);
    assertThat(eventFilter.apply(event)).isFalse();
  }
